...
const Page = (props) => {
    const { data, isLoading } = useSWR(`${paths.api.templates}/all`, fetcher)
    ...
    return (
        <>
            <Head>
                <title>
                    Templates | Panel Recurso Iglesia
                </title>
            </Head>
...
const LinkFormModal = () => {
    ...
    const modalData: Template = useModalStore(state => state.modalData)
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            // await axios.put(`${API_URL}/template/link`, {
            //     id: modalData.id,
            //     url: url,
            //     link: link,
            //     urlDate: new Date()
...
const DeleteLinkFormModal = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            // await axios.delete(`${API_URL}/template/link`, {
            //     data: {
            //         id: modalData.id
            //     }
            // })
